    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <div class="clickable"><i class="fas fa-cart-plus"></i><a href="addApart.php">Add Apart</a></div>
            ...
            <div class="clickable"><i class="fas fa-house"></i><a href="areApartRented.php">Rented Tax</a></div>
