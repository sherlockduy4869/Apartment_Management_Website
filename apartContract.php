            ...
            <table id="tbl_cart" width="100%">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="role">
                            <p style="color: <?php if($result['STATUS_APART'] != 'DONE'){ echo 'red';}?>; font-weight: <?php if($result['STATUS_APART'] != 'DONE'){ echo 'bold';}?>;"><?php echo $result['STATUS_APART'];?><?php echo $result['STATUS_APART'];?></p>
                        </td>
                        <td class="edit">
