...
<section id="interface">
    <div class="navigation">
            <div class="n1">
                ...
                <span>APARTMENT NEW CONTRACT NO TAX</span>
            </div>
            <div class="profile">
    ...
    <div class="boddyy">
            <div class="container">
                <div class="title">Edit Apartment New Contract No Tax</div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    {
                        echo $apartNewContractNoTaxEdit;
                    }
                    ?>
                    <div class="button">
                    ...
                    <div class="button">
                        <button class="btn btn-primary"><a href="newContract.php">BACK TO NEW CONTRACT NO TAX LIST</a></button>
                    </div>
                </form>
            </div>
        </div>
