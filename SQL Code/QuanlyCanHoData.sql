...
(
	...
	CHIA_KHOA_CO_OFFICE VARCHAR(255),
	PN1_OFFICE VARCHAR(255),
	PN2_OFFICE VARCHAR(255),
	PN3_OFFICE VARCHAR(255),
	PN4_OFFICE VARCHAR(255),
	BALCONY_OFFICE VARCHAR(255),
	MAILBOX_OFFICE VARCHAR(255),

	CHIA_KHOA_CO_CUSTOMER VARCHAR(255),
	PN1_CUSTOMER VARCHAR(255),
	PN2_CUSTOMER VARCHAR(255),
	PN3_CUSTOMER VARCHAR(255),
	PN4_CUSTOMER VARCHAR(255),
	BALCONY_CUSTOMER VARCHAR(255),
	MAILBOX_CUSTOMER VARCHAR(255),

	NOTE_FOR_KEY TEXT,

	THE_THANG_MAY_OFFICE VARCHAR(255),
	THE_TU_LON_OFFICE VARCHAR(255),
	THE_TU_NHO_OFFICE VARCHAR(255),

	THE_THANG_MAY_CUSTOMER VARCHAR(255),
	THE_TU_LON_CUSTOMER VARCHAR(255),
	THE_TU_NHO_CUSTOMER VARCHAR(255),
...
AS
BEGIN
	DECLARE owner_hous VARCHAR(255);
	DECLARE owner_phon VARCHAR(255);
	DECLARE owner_mail VARCHAR(255);
	DECLARE name_agen VARCHAR(255);
	DECLARE phone_agen VARCHAR(255);
	DECLARE mail_agen VARCHAR(255);
	DECLARE apart_area VARCHAR(255);
	DECLARE cus_name VARCHAR(255);
	DECLARE cus_phone VARCHAR(255);
	DECLARE cus_email VARCHAR(255);
	...
	SELECT HOUSE_OWNER INTO owner_hous FROM tbl_apartment_rented_no_tax WHERE APARTMENT_CODE = NEW.APARTMENT_CODE;
	SELECT PHONE_OWNER INTO owner_phon FROM tbl_apartment_rented_no_tax WHERE APARTMENT_CODE = NEW.APARTMENT_CODE;
	SELECT EMAIL_OWNER INTO owner_mail FROM tbl_apartment_rented_no_tax WHERE APARTMENT_CODE = NEW.APARTMENT_CODE;
	...
	SELECT AREA_APART INTO apart_area FROM tbl_apartment_rented_no_tax WHERE APARTMENT_CODE = NEW.APARTMENT_CODE;
	...
	INSERT INTO tbl_apartment_rented_no_tax_new_contract(APARTMENT_CODE,HOUSE_OWNER,PHONE_OWNER,EMAIL_OWNER,AGENCY_NAME,AGENCY_PHONE,AGENCY_EMAIL,AREA_APART,CUTOMER_NAME,CUTOMER_PHONE,CUTOMER_EMAIL
	,FEE_PER_MONTH,MANAGEMENT_FEE,OWNER_RECIEVED,START_DAY,END_DAY,DAY_REMIND,PAYMENT_TERM,NOTE) 
	VALUES(NEW.APARTMENT_CODE,owner_hous,owner_phon,owner_mail,name_agen,phone_agen,mail_agen,apart_area
	,cus_name,cus_phone,cus_email,fee_month,fee_management,owner_recie,day_start,day_end,remind_day,term_pay,notee);
