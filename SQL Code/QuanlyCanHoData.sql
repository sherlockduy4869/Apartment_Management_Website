...
CREATE TABLE tbl_apartment_rented_not_money
(
	APARTMENT_CODE VARCHAR(255) PRIMARY KEY,
	HOUSE_OWNER VARCHAR(255),
	PHONE_OWNER VARCHAR(255),
...
--TRIGGER FOR ADDING INFORMATION FOR APARTMENT_CONTRACT
CREATE TRIGGER ADDING_APARTMENT_CONTRACT_NOT_MONEY
...
BEGIN
	...
	INSERT INTO tbl_apartment_contract(APARTMENT_CODE,START_DAY,END_DAY,FEE_PER_MONTH,DATE_REMIND,NUM_DAY_REMIND) 
	VALUES(apart_code,day_start,day_end,fee_per_month,remind_date,num_day_remind);
END
GO
...
--Fixed
--TRIGGER FOR REMOVING APARTMENT_CART WHEN ADDING NEW RENTED APARTMENT
CREATE TRIGGER REMOVING_APARMENT_CART_NOT_MONEY
ON APARTMENT_INFO
FOR INSERT
AS
BEGIN
...
--Fixed
--TRIGGER FOR REMOVING APARTMENT_CART WHEN ADDING NEW RENTED APARTMENT
CREATE TRIGGER ADDING_APARMENT_CART_NOT_MONEY
ON APARTMENT_INFO
FOR DELETE
AS
BEGIN
