...
(
	...
	CLEANING_FEE FLOAT,
	TOTAL_AMOUNT FLOAT,
	STATUS_TAX_FEE VARCHAR(255) DEFAULT '0',
	STATUS_TAX_DECLARE VARCHAR(255) DEFAULT '0',
	STATUS_TAX_MANAGEMENT VARCHAR(255) DEFAULT '0',
	STATUS_REFUND_FOR_TENANT VARCHAR(255) DEFAULT '0',
	STATUS_CLEANING_FEE VARCHAR(255) DEFAULT '0',
	STATUS_TOTAL_AMOUNT VARCHAR(255) DEFAULT '0',
	FOREIGN KEY(APARTMENT_CODE) REFERENCES tbl_apartment_rented(APARTMENT_CODE)
)
GO
